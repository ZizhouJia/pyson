...
OBJECT_NAME: ([A-Za-z_]+[A-Za-z0-9_]*)?'#'(([A-Za-z_]+[A-Za-z0-9_]*|'0'|[1-9][0-9]*)'.')*([A-Za-z_]+[A-Za-z0-9_]*|'0'|[1-9][0-9]*); 
COLON: ',';
COMMA: ':';
LEFT_DICT:'{';
RIGHT_DICT:'}';
...
value: INT|FLOAT|TRUE|FALSE|NONE|STRING|CTX|OBJECT_NAME|item_dict|item_list|item_object;
